...
if 3 in prime_numbers:
    print("Дано число входить в список")
else:
    print("Дано число не входить в список")
...
user.get(key, "Такий ключ відсутній у словнику")
...
# # print(f"Найбільш віддалене місто '{city}', відстань до Києва {cities[city]}")
...
#         chars[char] = my_string.count(char)

# # print(chars)
# max_count_chars = sorted(chars, key=chars.get, reverse=True)
# print(max_count_chars[:3])
...
# if len(city) >= 3:
#     for post_city in post_ukr:
#         if city in post_city:
#             print("Доставка Укрпоштою")
#             break
#     else:
#         print("Доставка неможлива Укрпоштою")

#     for post_city in post_new:
#         if city in post_city:
#             print("Доставка Новою поштою")
#             break
#     else:
#         print("Доставка неможлива Новою поштою")
# else:
#     print("Ввели мло літер")
