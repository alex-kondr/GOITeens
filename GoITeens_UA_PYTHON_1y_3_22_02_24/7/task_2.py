...
# my_list_2 = [number for number in my_list if number < avg]
# print(my_list_2)
...
# my_list_1 = [1, 5, 8, 10, ["Кіт", "Собака", "Корова"]]
# my_list_2 = ["Кіт", "Собака", "Корова"]
...
# Написати програму, яка виведе факторіал числа, яке задасть користувач
