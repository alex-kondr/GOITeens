...
# print(f"Місто '{city_max}' найбільш віддалене від Києва, а саме на {distance} км")

# city = max(cities, key=cities.get)
# print(f"Місто '{city}' найбільш віддалене від Києва, а саме на {cities.get(city)} км")
...
# user_city = input("Введіть назву міста не менше трьох символів: ")

# while len(user_city) < user_city_min_lenth:
#     user_city = input("Введіть назву міста не менше трьох символів: ")

# for city in post_ukr:
#     if user_city in city:
#         print(f"У місто '{city}' можна доставити посилку за допомогою Укрпошти")
#         break

# for city in post_new:
#     if user_city in city:
#         print(f"У місто '{city}' можна доставити посилку за допомогою Нової Пошти")
#         break
...
#     hotels[vaucher[0]] = hotels.get(vaucher[0], 0) + vaucher[2]
...
# strings = [
#     "Створіть програму, яка приймає список",
#     "зустрічаються в цих рядках", "список",
#     "# Створіть програму, яка приймає список рядків та повертає список унікальних слів, \n# які зустрічаються в цих рядках."
#     ]
...
# strings = [
#     "Створіть програму, яка приймає список",
#     "зустрічаються в цих рядках",
#     "список",
#     "# Створіть програму, яка приймає список рядків та повертає список унікальних слів, \n# які зустрічаються в цих рядках."
# ]

# letters = [string[0] for string in strings]
# # for string in strings:
