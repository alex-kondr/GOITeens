...
with open("repeated_text.txt", "r", encoding="utf-8") as file:
    # ....
...
# Напишіть функцію, яка приймає шлях до
# файла як аргумент і повертає кількість рядків у файлі.
