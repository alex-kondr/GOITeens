clients = [
    ...
    ['добродій Герман Гаврюшенко', 'шосе Амурський 4-й, буд. 830 кв. 60, Теребовля, 53150', 26, 9],
    ...
    ['пан Дмитро Гаврилишин', 'шосе Аптекарський, буд. 0 кв. 83, Синельникове, 06821', 58, 40],
...
commands = [
    ...
    "7. Відсортувати список клієнтів за прізвищем",
    "8. Відсортувати список клієнтів за віком"
    "9. Хто перебуває в номері",
    "10. Показати відгуки",
    "11. Показати вільні номери",
    "12. Забронювати номер"
]
...
while True:
    ...
    if command == "2":
        ...
        for client_ in clients:
            if client in client_:
                clients.remove(client_)
                client_.append(rating)
                rating_customers.append(client_)
